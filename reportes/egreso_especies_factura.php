...
require('Factura_egresos_especies.php');
...
$egreso_especies= new Egreso_especies();
$rsptav = $egreso_especies->egreso_especies_cabecera($_GET["id"]);
...
$pdf->fact_dev( utf8_decode("Egreso Nº "), " $regv->numero_documento" );
$pdf->temporaire( "" );
...
$rsptad = $egreso_especies->detalle_especies_cabecera($_GET["id"]);
...
$pdf->Output('Reporte de Egreso','I');
