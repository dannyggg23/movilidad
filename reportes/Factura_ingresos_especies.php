...
function addSociete( $nom, $adresse,$logo,$ext_logo )
{
	...
	$this->Image($logo ,3 ,3, 125 , 23 , $ext_logo);
	$this->SetXY( $x1, $y1 );
...
// Client address
function addClientAdresse( $cliente,$domicilio,$num_documento,$email,$telefono,$lugar )
{
	$r1     = $this->w - 180;
	$r2     = $r1 + 68;
	$y1     = 40;
	$this->SetXY( $r1, $y1+15);
	$this->SetFont( "Arial", "B", 9);
	$this->MultiCell( 60, 4, utf8_decode("Ubicación : ").$cliente);
	$this->SetXY( $r1, $y1+19);
	$this->SetFont( "Arial", "", 9);
	$this->MultiCell( 150, 4, $lugar);
	$this->SetXY( $r1, $y1+23);
...
function addCadreEurosFrancs($impuesto)
{
	...
	$this->SetFont( "Arial", "B", 8);
	$this->SetXY( $r1+22, $y1 );
	$this->Cell(15,4, "TOTALES", "C");
	$this->SetFont( "Arial", "", 8);
	//$this->SetXY( $r1+42, $y1 );
	//$this->Cell(15,4, "FRANCS", 0, 0, "C");
	$this->SetFont( "Arial", "B", 6);
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(20,4, "SUBTOTAL", "C");
	$this->SetXY( $r1, $y1+10 );
	$this->Cell(20,4, $impuesto,  "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(20,4, "TOTAL",  "C");
}
