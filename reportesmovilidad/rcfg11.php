...
define("EWR_PROJECT_ID", "{04F6FC29-9BA8-4256-B631-5194ABED24B7}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "reportes_movilidad", TRUE); // Project Name
...
define("EWR_FONT_SIZE", 15, TRUE);
$EWR_BODY_CLASS = "hold-transition skin-blue-light";
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "movilidad", "qs" => "`", "qe" => "`");
