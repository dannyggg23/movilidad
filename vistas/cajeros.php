                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="cedula" id="cedula" maxlength="100" placeholder="Cedula" required>
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Función:</label>
                            <input type="text" class="form-control" name="funcion" id="funcion" maxlength="256" placeholder="Funcion">
                          </div>
